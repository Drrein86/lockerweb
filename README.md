# LockerWeb - מערכת ניהול לוקרים חכמה

מערכת לניהול לוקרים חכמים עבור שליחים ומשתמשים, המאפשרת שליחה ואיסוף חבילות בצורה נוחה ובטוחה.

## תכונות עיקריות

- ✅ ניהול משתמשים (מנהלים, שליחים ולקוחות)
- 🔒 מערכת הרשאות מתקדמת
- 📦 ניהול חבילות ומשלוחים
- 🔄 ממשק WebSocket לתקשורת בזמן אמת
...
```bash
# .env
DATABASE_URL="postgresql://user:password@localhost:5432/lockerweb"
JWT_SECRET="your-secret-key"
```

3. הרץ את הגירות ה-Prisma:
```bash
...
├── lib/              # שירותים ופונקציות
└── styles/           # סגנונות גלובליים
```

## הרשאות

- **מנהל**: גישה מלאה למערכת, ניהול משתמשים ולוקרים
- **שליח**: ניהול משלוחים והכנסת חבילות ללוקרים
- **לקוח**: צפייה בחבילות ואיסוף מהלוקר

## פיתוח

הפרויקט משתמש ב-ESLint ו-TypeScript לאבטחת איכות הקוד. הרץ את הבדיקות לפני העלאת קוד:
...
מוזמנים לתרום לפרויקט! אנא צרו issue או pull request.
